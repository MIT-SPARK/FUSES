...
% This script uses ground-truth for weights
...
%% Datasets / settings
ignoreFrontend = true;
bWeight = 0.2; % binary weights are bWeight for same labels and 0 otherwise
useHDF5 = false;
saveEps = false;
...
% modify hdf5
hdf5modifyAppName = 'frontend-removeNegative-hdf5';
...
for i = 1:nrFrames
    ...
    modifyCommand = sprintf(hdf5modifyCommand, noWeight_hdfFileName, hdfFileName, 0.0, bWeight);
    disp(' ')
    disp(modifyCommand)
