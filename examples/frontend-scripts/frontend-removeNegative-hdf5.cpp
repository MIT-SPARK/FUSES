...
/**
 * @file   frontend-removeNegative-hdf5.cpp
 * @brief  take crf stored in the input hdf5 files and change the weights of
 *         the binary factor as (a + b*initialWeight) if this is positive
 *         or 0 otherwise
